        ...
        children: [
          {
            ...
            group: "1-1",
            groupInnerId: "0",
            path: "/product/flex#FLEX-0-0",
          },
          {
            name: "Contract Management",
            group: "1-1",
            groupInnerId: "1",
            path: "/product/flex#FLEX-0-1",
          },
          {
            name: "Space Inventory Management",
            group: "1-1",
            groupInnerId: "2",
            path: "/product/flex#FLEX-0-3",
          },
          {
            name: "Billing & Payment",
            group: "1-1",
            groupInnerId: "3",
            path: "/product/flex#FLEX-0-7",
          },
          {
            name: "Dashboard",
            group: "1-1",
            groupInnerId: "4",
            path: "/product/flex#FLEX-0-11",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            group: "1-2",
            groupInnerId: "0",
            path: "/product/tea#TEA-0-0",
          },
          {
            name: "Meeting Room Booking",
            group: "1-2",
            groupInnerId: "1",
            path: "/product/tea#TEA-0-1",
          },
          {
            name: "Tenant Management",
            group: "1-2",
            groupInnerId: "2",
            path: "/product/tea#TEA-0-2",
          },
          {
            name: "Billing & Payments",
            group: "1-2",
            groupInnerId: "3",
            path: "/product/tea#TEA-0-4",
          },
          {
            name: "Reports & Analytics",
            group: "1-2",
            groupInnerId: "4",
            path: "/product/tea#TEA-0-5",
          },
        ],
      },
    ],

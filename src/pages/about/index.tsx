      ...
      <main className={` min-h-screen min-w-320`}>
        ...
        <div className="flex justify-center h-full my-0 mx-auto  bg-white">
          <div className="w-full h-full">
            <Head>
              <title>
                About BOSS - Proptech Software and Solution Provider
              </title>
              <meta
                name="description"
            ...
            <main className={`w-full`}>
              ...
              >
                ...
                >
                  <div className={`lg:w-568`}>
                    <h3
                      className={`text-neutral9 lg:text-xlx lg:pb-4 maxlg:pt-10`}
                    >
                      Who we are
                    </h3>
                    <h4
                    ...
                    <h5 className={`text-neutral12 text-base maxlg:pb-4`}>
                      Connected business modules ensure your business efficiency
                      and growth. We invest talent and resources into a
                      repeatable process that outputs valuable companies.
                    </h5>
                  </div>
                  <div className={`lg:w-568 lg:self-end`}>
                    ...
                    <h5
                      className={`text-neutral12 text-2xl lg:pb-6 maxlg:pb-2`}
                    >
                      BOSS = Business Operating System for Space
                    </h5>
                    <h5
                      className={`maxlg:hidden text-neutral12 text-base maxlg:pb-4`}
                    >
                      BOSS helps you to automate workspace processes, manage
                      tenant lifecycles and streamline flex & workspace
                      operations. With BOSS, you can strengthen a gratifying
                      customer experience and boost retention. In turn, maximize
                      profitability while ensuring accuracy and efficiency.
                    </h5>
                    <div className="lg:hidden">
                      <h5 className={`text-neutral12 text-base maxlg:pb-2.5`}>
                        BOSS helps you to automate workspace processes, manage
                        tenant lifecycles and streamline flex & workspace
                        operations.
                      </h5>
                      <h5 className={`text-neutral12 text-base maxlg:pb-4`}>
                        With BOSS, you can strengthen a gratifying customer
                        experience and boost retention. In turn, maximize
                        profitability while ensuring accuracy and efficiency.
                      </h5>
                    </div>
                  </div>
                  <div className={`lg:w-568`}>
                    ...
                    <h5 className={`text-neutral12 text-base maxlg:pb-4`}>
                      ...
                      technology innovation, venture building, and business
                      model innovation.
                    </h5>
                  </div>
                </div>
              ...
              >
                ...
                <p
                  className={`${styles.marginAuto} text-center text-base lg:w-568`}
                >
                  BOSS’s management team has a proven track record in proptech
                  in Asia, having served as the leadership team of some of the
                  most technology-forward real estate brands in Asia.
                </p>
              </div>
              <div

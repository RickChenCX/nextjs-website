...
export default function Flex() {
  return (
    <main className={`max-w-full`}>
      ...
      >
        <h3 className={`xl:pb-4 xs:pb-3`}>For landlords or space operators</h3>
        <h1 className={`xl:pb-2 xl:f-5xxl xs:pb-6 xs:3xxl`}>
          BOSS Tenant Engage
        </h1>
        <h4 className={`xl:f-text-sml xs:tex-sm`}>
          BOSS Tenant Engage is a comprehensive platform for landlords or space
          operators to connect better with tenants, strengthen satisfaction and
          conduct tenant management in an automated and efficient way.
        </h4>
      </div>
